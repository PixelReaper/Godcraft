...
public class MCreatorHexadoriumTransposerGUI extends Elementsgodcraft.ModElement {
	public static int GUIID = 1;
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;

	public MCreatorHexadoriumTransposerGUI(Elementsgodcraft instance) {
		super(instance, 12);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			if (ent instanceof MCreatorHexadoriumTransposer.TileEntityCustom)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("godcraft:textures/hexadoriumtransposergui.png");
