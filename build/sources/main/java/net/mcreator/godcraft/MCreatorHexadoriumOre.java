...
public class MCreatorHexadoriumOre extends Elementsgodcraft.ModElement {
	@GameRegistry.ObjectHolder("godcraft:hexadoriumore")
	public static final Block block = null;

	public MCreatorHexadoriumOre(Elementsgodcraft instance) {
		super(instance, 7);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("godcraft:hexadoriumore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("hexadoriumore");
			setUnlocalizedName("hexadoriumore");
